    ...
    <nav class="navbar navbar-expand-lg bg-dark ">
        <div class="container-fluid m-0 p-0">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <form class="d-flex me-2" action="" method="POST" onsubmit="return airline()">
        ...
        <div class="row mt-5 m-0 p-0">
            ...
            <div class="col-sm-3 mb-3 mb-sm-0">
                <div class="card bg-warning text-light">
                    <div class="card-body text-center">
                       <h5> <a href="list_flightss.php" class="card-title text-decoration-none fw-bold">Flights</a></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mb-3 mb-sm-0">
                <div class="card bg-info text-light">
                    <div class="card-body text-center">
                        <h5><a href="view_airlines.php" class="card-title text-decoration-none fw-bold">Available Airlines</a></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
